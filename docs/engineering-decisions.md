...
## 6. 성능 — 그리고 개선 뒤에 드러난 새 병목

| 항목 | 전 | 후 |
|---|---|---|
| "저번주 정리해줘" (7일) — `asyncio.gather` | ~20초 (순차) | **6.4초** |
| "저번주 vs 이번주" (14일) | ~45초 | **~10초** |
| 위 7일 정리 — 하루 요약 캐시 적중 | 7.5초 | **1.7~2.0초** |
| 브라우저 제출 → 화면 완성 | ~20초 | **4.6초** (첫 글자 2.0초) |
...
전체 23건은 [`troubleshooting-star.md`](troubleshooting-star.md)에 STAR 형식으로 있다.
